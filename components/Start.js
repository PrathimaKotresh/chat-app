          ...
          <View style={styles.inputSectionContainer}>
            ...
            <View style={styles.content}>
              ...
              <View style={styles.colorSelection}>
                <View style={this.state.colorSelection === 1 ? styles.colorWrapper : styles.colorDefaultWrapper}>
                  <TouchableOpacity
                    onPress={() => this.setState({ color: '#090C08', colorSelection: 1 })}
                    style={[styles.colorButton, styles.color1]}
                  />
                </View>
                <View style={this.state.colorSelection === 2 ? styles.colorWrapper : styles.colorDefaultWrapper}>
                  <TouchableOpacity
                    onPress={() => this.setState({ color: '#474056', colorSelection: 2 })}
                    style={[styles.colorButton, styles.color2]}
                  />
                </View>
                <View style={this.state.colorSelection === 3 ? styles.colorWrapper : styles.colorDefaultWrapper}>
                  <TouchableOpacity
                    onPress={() => this.setState({ color: '#8A95A5', colorSelection: 3 })}
                    style={[styles.colorButton, styles.color3]}
                  />
                </View>
                <View style={this.state.colorSelection === 4 ? styles.colorWrapper : styles.colorDefaultWrapper}>
                  <TouchableOpacity
